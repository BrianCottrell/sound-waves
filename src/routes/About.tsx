...
const About = () => {
	...
	return (
		<Route title="About" description={`A marketplace for voice app data on the the Ocean ${market.network} Network.`}>
			<Content>
				<p>
					Sound Waves is an online network of voice app data, distributed by&nbsp;
