...
var ServiceAgreement = (function (_super) {
    ...
    ServiceAgreement.prototype.signServiceAgreement = function (ddo, index, serviceAgreementId, agreementConditionsIds, consumer) {
        return __awaiter(this, void 0, void 0, function () {
            var service, timelockValues, timeoutValues, serviceAgreementHashSignature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        service = ddo.findServiceById(index);
                    ...
                    case 1:
                        ...
                        return [2, utils_1.zeroX(serviceAgreementHashSignature)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.ocean.utils.signature.signText(serviceAgreementHash, consumer.getId(), consumer.getPassword())];
                    case 1:
                        serviceAgreementHashSignature = _a.sent();
    ...
    ServiceAgreement.prototype.hashServiceAgreement = function (serviceAgreementTemplateId, serviceAgreementId, valueHashes, timelocks, timeouts) {
        ...
        return (_a = this.web3.utils).soliditySha3.apply(_a, args);
    };
    ServiceAgreement.prototype.getTimeValuesFromService = function (service, type) {
        var timeoutValues = service.attributes.serviceAgreementTemplate.conditions.map(function (condition) { return condition[type]; });
