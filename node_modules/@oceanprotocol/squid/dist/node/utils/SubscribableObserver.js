...
var SubscribableObserver = (function () {
    ...
    SubscribableObserver.prototype.subscribe = function (onNext, onComplete, onError) {
        ...
        var subscription = { onNext: onNext, onComplete: onComplete, onError: onError };
        this.subscriptions.add(subscription);
        return {
            unsubscribe: function () { return _this.subscriptions.delete(subscription); }
        };
    };
    ...
    SubscribableObserver.prototype.emit = function (type, value) {
        Array.from(this.subscriptions)
            .map(function (subscription) { return subscription[type]; })
            .filter(function (callback) { return callback && typeof callback === 'function'; })
            .forEach(function (callback) { return callback(value); });
    };
