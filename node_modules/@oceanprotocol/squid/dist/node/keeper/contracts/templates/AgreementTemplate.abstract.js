...
var AgreementTemplate = (function (_super) {
    ...
    AgreementTemplate.prototype.createAgreement = function (agreementId, did, conditionIds, timeLocks, timeOuts, extraArgs, from) {
        return this.sendFrom('createAgreement', __spreadArrays([
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [2, (_a.sent()).map(function (address) {
                            return _this.ocean.keeper.getConditionByAddress(address);
                        })];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        name = (_a.sent()).find(function (_a) {
                            var conditionRef = _a.name;
                            return conditionRef === ref;
                        }).contractName;
                        return [4, this.getConditions()];
                    case 2: return [2, (_a.sent()).find(function (condition) { return condition.contractName === name; })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4, this.getConditions()];
                    case 3:
                        conditionIdByConddition = (_a.sent()).reduce(function (acc, _a, i) {
                            var _b;
                            var contractName = _a.contractName;
                            return (__assign(__assign({}, acc), (_b = {}, _b[contractName] = conditionIds[i], _b)));
                        }, {});
                        statesPromises = Object.keys(dependencies).map(function (ref, i) { return __awaiter(_this, void 0, void 0, function () {
                            var contractName, _a;
                    ...
                    case 4:
                        states = _a.sent();
                        return [2, states.reduce(function (acc, _a) {
                                var _b;
                                ...
                                return __assign(__assign({}, acc), (_b = {}, _b[ref] = {
                                    condition: ref,
                                    contractName: contractName,
                                    state: state,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        Object.values(status || []).forEach(function (_a, i) {
