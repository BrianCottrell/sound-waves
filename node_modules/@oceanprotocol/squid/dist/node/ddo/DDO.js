...
var DDO = (function () {
    ...
    DDO.prototype.findServiceById = function (index) {
        ...
        var service = this.service.find(function (s) { return s.index === index; });
        return service;
    };
    ...
    DDO.prototype.getChecksum = function () {
        ...
        var _a = attributes.main, files = _a.files, name = _a.name, author = _a.author, license = _a.license;
        var values = __spreadArrays((files || []).map(function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4, this.generateProof(ocean, publicKey, password)];
                    case 1:
                        _a.proof = _b.sent();
                        return [2];
                }
